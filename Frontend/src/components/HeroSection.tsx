...
function HeroSection() {
  return (
    <div className="grid grid-cols-1 mt-20 items-start w-[70%] gap-10 md:grid-cols-2">
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-2 ">
        <Image
          ...
          className="aspect-square w-72 h-96 rounded-xl object-cover row-span-3 shadow-xl mt-12"
        />
        <Image
          src={nftObject[1].image}
          key={nftObject[1].key}
          alt={nftObject[1].name}
          className="aspect-square w-52 h-72  rounded-xl object-cover shadow-xl"
        />
        <Image
          src={nftObject[2].image}
          key={nftObject[2].key}
          alt={nftObject[2].name}
          className="aspect-square  w-64 h-80 rounded-xl object-cover shadow-xl"
        />
      </div>
    </div>
  );
